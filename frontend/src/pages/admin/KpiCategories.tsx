...
function PasswordModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <Modal open onClose={onClose} title="Изменить пароль администратора">
...
export default function AdminKpi() {
  ...
  return (
    <div className="space-y-6 animate-in">
      ...
      {/* Add/Edit */}
      <Modal open={formOpen} onClose={() => setFormOpen(false)} title={editingId ? "Редактировать категорию" : "Новая KPI категория"}>
        <div className="space-y-4">
          <div className="space-y-1.5">
